...
@Validated
@RestController
@RequestMapping(path = ["/api/v2/smart_contract"], produces = [MediaType.APPLICATION_JSON_VALUE], consumes = [org.springframework.http.MediaType.APPLICATION_JSON_VALUE])
@Tag(
    name = "Smart Contract",
