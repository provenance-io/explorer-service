...
class SmartContractController(private val scService: SmartContractService) {
    ...
    fun getCodesList(
        ...
        @RequestParam(name = "has_contracts", required = false) hasContracts: Boolean?
    ) = ResponseEntity.ok(scService.getAllScCodesPaginated(page, count, creator, hasContracts))
    ...
    fun getContractsByCode(
        ...
        @RequestParam(required = false) admin: String?
    ) = ResponseEntity.ok(scService.getContractsByCode(id, page, count, creator, admin))
    ...
    ) = ResponseEntity.ok(scService.getAllScContractsPaginated(page, count, creator, admin, label))
    ...
    fun getContractLabels() = ResponseEntity.ok(scService.getContractLabels())
}
