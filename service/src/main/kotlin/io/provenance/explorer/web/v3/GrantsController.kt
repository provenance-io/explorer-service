...
class GrantsController(private val grantService: GrantService) {
    ...
    ) = ResponseEntity.ok(grantService.getGrantsForGranteePaginated(address, page, count))
    ...
    fun getGrantsForGranter(
        ...
        @RequestParam(defaultValue = "10") @Min(1) @Max(100) count: Int,
        @ApiParam(defaultValue = "1", required = false) @RequestParam(defaultValue = "1") @Min(1) page: Int
    ) = ResponseEntity.ok(grantService.getGrantsForGranterPaginated(address, page, count))
    ...
    fun getAllowancesForGrantee(
        ...
        @RequestParam(defaultValue = "10") @Min(1) @Max(100) count: Int,
        @ApiParam(defaultValue = "1", required = false) @RequestParam(defaultValue = "1") @Min(1) page: Int
    ) = ResponseEntity.ok(grantService.getAllowancesForGranteePaginated(address, page, count))
    ...
    fun getAllowancesByGranter(
        ...
        @RequestParam(defaultValue = "10") @Min(1) @Max(100) count: Int,
        @ApiParam(defaultValue = "1", required = false) @RequestParam(defaultValue = "1") @Min(1) page: Int
    ) = ResponseEntity.ok(grantService.getAllowancesByGranterPaginated(address, page, count))
}
