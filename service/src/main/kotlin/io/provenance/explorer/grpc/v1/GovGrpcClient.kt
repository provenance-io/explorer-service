        ...
        if (UNDER_MAINTENANCE)
            queryParamsResponse {
                this.depositParams = depositParams {
                    this.minDeposit.add(defaultCoin(UTILITY_TOKEN))
                }
                this.tallyParams = tallyParams {
                    this.quorum = "0"
                    this.threshold = "0"
                    this.vetoThreshold = "0"
                }
            }
        else govClient.params(queryParamsRequest { this.paramsType = param.name })
